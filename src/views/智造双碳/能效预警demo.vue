<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input placeholder="检测点名称" style="width: 150px;" class="filter-item" />

      <el-input placeholder="检测点地址" style="width: 150px;" class="filter-item" />
    ...
    >
      ...
      <el-table-column label="检测点名称" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
        </template>
      </el-table-column>

      <el-table-column label="检测点地址" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
        </template>
      </el-table-column>

      <el-table-column label="实时功率" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
        </template>
      </el-table-column>

      <el-table-column label="实时电压" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.title }}</span>
        </template>
      </el-table-column>
...
const calendarTypeOptions = [
  { key: 'CN', display_name: 'OK' },
  { key: 'US', display_name: 'ERROR' }
]
